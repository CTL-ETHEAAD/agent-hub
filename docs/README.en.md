...
|---|---|---|
| [Quick Start](../README.en.md) | First-time users | Installation, startup, asset initialization, and first validation |
...
Use the code, root README, and design documents in this directory as the reference for current behavior.
